      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-16 pb-8">
        ...
        >
          <div className="flex flex-wrap items-center gap-6 text-sm text-slate-400">
            ...
            <span className="flex items-center gap-2">
              ...
              江西省南昌市东湖区四纬路52号中南物资大楼 & 湖南省岳阳市临湘市长安街道南正街121号
            </span>
          </div>
        </div>
        ...
        <div className="mt-8 flex flex-col md:flex-row items-center justify-between gap-4 border-t border-white/10 pt-8">
          ...
          <div className="flex items-center gap-6 text-sm text-slate-500">
            ...
            <a href="#" className="hover:text-slate-300 transition-colors cursor-pointer">ISP许可证：赣B1.B2-20100064 赣ICP备13008319号</a>
          </div>
        </div>
      </div>
    </footer>
